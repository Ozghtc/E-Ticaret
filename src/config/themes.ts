...
// ✅ AKTİF TEMALAR
{
  ...
  category: "👕 Tekstil",
  emoji: "👕",
  description: t("common.moda_ve_giyim_mağazaları_için"),
  available: true,
  ...
  category: "💻 Teknoloji",
  emoji: "💻",
  description: t("common.teknoloji_ürünleri_için_modern_tema"),
  available: true,
  ...
  category: "🍪 Gıda",
  emoji: "🍪",
  description: t("common.organik_ve_doğal_ürünler_için"),
  available: true,
  ...
  category: "🛋️ Mobilya",
  emoji: "🛋️",
  description: t("common.temiz_ve_minimal_tasarım"),
  available: true,
  preview: "https://images.pexels.com/photos/1884581/pexels-photo-1884581.jpeg?auto=compress&cs=tinysrgb&w=400",
  color: "bg-gray-100",
  ...
  category: "🏪 Genel",
  emoji: "🏪",
  description: t("common.çok_kategorili_büyük_mağazalar_için"),
  available: true,
  preview: "https://images.pexels.com/photos/1884581/pexels-photo-1884581.jpeg?auto=compress&cs=tinysrgb&w=400",
  color: "bg-purple-100",
...
// 🔄 GELİŞTİRİLECEK TEMALAR
{
  ...
  category: "👕 Tekstil",
  emoji: "👗",
  description: t("common.kadın_butikleri_zarif_giyim"),
  available: true,
  preview: "https://images.pexels.com/photos/1884581/pexels-photo-1884581.jpeg?auto=compress&cs=tinysrgb&w=400",
  color: "bg-pink-50",
  ...
  category: "👕 Tekstil",
  emoji: "💎",
  description: t("common.lüks_markalar_pahalı_ürün_satıcıları"),
  available: true,
  preview: "https://images.pexels.com/photos/356056/pexels-photo-356056.jpeg?auto=compress&cs=tinysrgb&w=400",
  color: "bg-yellow-100",
  ...
  category: "👕 Tekstil",
  emoji: "🏙️",
  description: t("common.genç_kitle_streetwear_modası"),
  available: true,
  preview: "https://images.pexels.com/photos/1884581/pexels-photo-1884581.jpeg?auto=compress&cs=tinysrgb&w=400",
  color: "bg-gray-100",
  ...
  category: "👕 Tekstil",
  emoji: "🧼",
  description: t("common.minimal_tasarım_seven_müşteriler"),
  available: true,
  preview: "https://images.pexels.com/photos/1884581/pexels-photo-1884581.jpeg?auto=compress&cs=tinysrgb&w=400",
  color: "bg-green-50",
  ...
  category: "👕 Tekstil",
  emoji: "🎞️",
  description: t("common.vintage_ürün_mağazaları"),
  available: true,
  preview: "https://images.pexels.com/photos/1884581/pexels-photo-1884581.jpeg?auto=compress&cs=tinysrgb&w=400",
  color: "bg-amber-100",
  ...
  category: "👕 Tekstil",
  emoji: "🧕",
  description: t("common.tesettür_giyim_mağazaları"),
  available: true,
  preview: "https://images.pexels.com/photos/1884581/pexels-photo-1884581.jpeg?auto=compress&cs=tinysrgb&w=400",
  color: "bg-purple-100",
  ...
  category: "👕 Tekstil",
  emoji: "👶",
  description: t("common.anne_babalar_çocuk_giyim_satıcıları"),
  available: true,
  preview: "https://images.pexels.com/photos/1884581/pexels-photo-1884581.jpeg?auto=compress&cs=tinysrgb&w=400",
  color: "bg-yellow-100",
  ...
  category: "👕 Tekstil",
  emoji: "🔖",
  description: t("common.i_ndirimli_ürün_satışı_yapan_mağazalar"),
  available: true,
  preview: "https://images.pexels.com/photos/1884581/pexels-photo-1884581.jpeg?auto=compress&cs=tinysrgb&w=400",
  color: "bg-red-100",
  ...
  category: "👕 Tekstil",
  emoji: "🌿",
  description: t("common.organik_kumaş_çevre_dostu_ürün_mağazaları"),
  available: true,
  preview: "https://images.pexels.com/photos/1884581/pexels-photo-1884581.jpeg?auto=compress&cs=tinysrgb&w=400",
  color: "bg-green-100",
