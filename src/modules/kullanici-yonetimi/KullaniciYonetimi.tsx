  ...
  return <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <p className="text-gray-600 text-lg">{t("common.bu_sayfa_henüz_geliştirilme_aşamasındadır")}</p>
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-4 text-left max-w-md mx-auto">
            ...
            <p className="text-sm text-purple-700">{t("common.sistem_yöneticisi_sen_tüm_altyapı_yönetimi_ve_rapor_ekranları")}</p>
          </div>
        </div>
      </div>
    </div>;
