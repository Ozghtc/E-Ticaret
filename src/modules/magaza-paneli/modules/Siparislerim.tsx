  ...
  return <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <Link to="/admin/magaza-paneli" className="flex items-center text-white hover:text-green-200 mr-6">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-4">{t("common.siparişlerim")}</h1>
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-left max-w-md mx-auto">
            ...
            <p className="text-sm text-green-700">{t("common.gelen_siparişler_ve_sipariş_takibi")}</p>
          </div>
        </div>
      </div>
    </div>;
