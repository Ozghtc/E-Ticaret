...
export default function RestaurantDashboard({ magazaId, config }: RestaurantDashboardProps) {
  const navigate = useNavigate();
  const [currentTime, setCurrentTime] = useState(new Date());
  
  // Restoran özel state'leri - hiç ürün yok!
  const [reservations] = useState([
    { id: 1, table: 'Masa 3', customer: 'Ahmet Yılmaz', time: '19:00', guests: 4, status: 'confirmed' },
    { id: 2, table: 'Masa 7', customer: 'Zeynep Kaya', time: '20:30', guests: 2, status: 'pending' },
    { id: 3, table: 'Masa 12', customer: 'Mehmet Öz', time: '21:00', guests: 6, status: 'confirmed' }
  ]);
  
  const [tables] = useState([
    { id: 1, number: 1, capacity: 4, status: 'occupied', waiter: 'Ali' },
    { id: 2, number: 2, capacity: 2, status: 'available', waiter: null },
    { id: 3, number: 3, capacity: 6, status: 'reserved', waiter: 'Ayşe' },
    { id: 4, number: 4, capacity: 4, status: 'cleaning', waiter: null }
  ]);
  
  const [orders] = useState([
    { id: 1, table: 3, items: ['Adana Kebap', 'Ayran'], status: 'preparing', time: '18:45' },
    { id: 2, table: 7, items: ['Pizza Margherita', 'Kola'], status: 'ready', time: '19:10' },
    { id: 3, table: 1, items: ['Tavuk Şiş', 'Salata'], status: 'served', time: '18:30' }
  ]);
  ...
  const restaurantModules = [
    {
      ...
      description: 'Bugün 15 rezervasyon, 3 bekliyor',
      icon: Calendar,
    ...
    },
    {
      id: 'menu-yonetimi', 
      title: 'Menü Yönetimi',
      description: '45 yemek, 12 içecek aktif',
      icon: Menu,
    ...
    },
    {
      ...
      title: 'Mutfak Siparişleri (Canlı)',
      description: '6 sipariş hazırlanıyor',
      icon: ChefHat,
    ...
    },
    {
      id: 'masa-durumu',
      title: 'Masa Durumu',
      description: '16 masa: 8 dolu, 5 boş, 3 rezerve',
      icon: Monitor,
    ...
    },
    {
      id: 'kasa-z-raporu',
      title: 'Kasa & Z Raporu',
      description: 'Bugün: ₺3,450 | Bu ay: ₺89,200',
      icon: DollarSign, 
    ...
    },
    {
      id: 'stok-malzeme',
      title: 'Stok & Malzeme',
      description: '23 malzeme az, 5 malzeme tükendi',
      icon: Package,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50 restaurant-theme">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-2xl font-bold">{config?.customDashboard?.brandName || 'Restoran Yönetimi'}</h1>
            ...
            <div className="flex items-center space-x-6">
              <div className="text-center">
                <p className="text-sm text-orange-200">Bugünkü Satış</p>
              ...
              <div className="text-center">
                <p className="text-sm text-orange-200">Bekleyen Sipariş</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-green-500">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">Bugün Kazanç</p>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-yellow-500">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">Hazırlanan Sipariş</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8">
          {restaurantModules.map((module) => (
            <button
              ...
              className={`${module.color} text-white rounded-xl p-6 text-left transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl`}
            >
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
            {tables.map((table) => (
              <div
                key={table.id}
                className={`p-4 rounded-lg border-2 text-center ${getStatusColor(table.status)}`}
              >
                <p className="font-bold text-lg">Masa {table.number}</p>
                <p className="text-sm">{getStatusText(table.status)}</p>
                <p className="text-xs mt-1">{table.capacity} kişilik</p>
                {table.waiter && (
                  <p className="text-xs mt-1 font-semibold">Garson: {table.waiter}</p>
                )}
              </div>
            ))}
          </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          ...
          <div className="space-y-3">
            {reservations.map((reservation) => (
              <div key={reservation.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{reservation.table} • {reservation.guests} kişi</p>
                  </div>
                </div>
