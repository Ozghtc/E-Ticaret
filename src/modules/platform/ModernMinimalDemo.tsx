              ...
              {products.map((product) => (
                <div key={product.id} className="bg-white group">
                  <div className="relative mb-4">
                    ...
                    />
                    {product.discount > 0 && (
                      <div className="absolute top-4 left-4 bg-gray-900 text-white px-2 py-1 text-xs">
                      ...
                      <div className="flex items-center">
                        {[...Array(5)].map((_, i) => (
                          <Star
                            key={i}
                            size={12}
                            className={`${i < Math.floor(product.rating) ? 'text-gray-400 fill-current' : 'text-gray-200'}`}
                          />
                        ))}
                      </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">200 TL üzeri</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600 text-sm">SSL korumalı</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <RotateCcw className="w-6 h-6 text-gray-600" />
              </div>
              <h3 className="font-medium text-gray-900 mb-2 text-sm">Kolay İade</h3>
              <p className="text-gray-600 text-sm">30 gün içinde</p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600 text-sm">7/24 yardım</p>
            </div>
          </div>
          
          <div className="border-t border-gray-100 mt-8 pt-8 text-center">
            <p className="text-gray-500 text-sm">
              &copy; 2025 Minimal Store - Bu demo Altıntassoft tarafından oluşturulmuştur.
            </p>
          </div>
        </div>
      </footer>
