...
export const createDefaultPackages = async (): Promise<Paket[]> => {
  ...
  return [
    ...
    // SMS PAKETLERİ
    {
      ...
      createdAt: now,
      ozellikler: [
        { id: '1', baslik: '1.000 SMS Kredisi', aciklama: 'Toplam 1.000 adet SMS gönderim hakkı', dahil: true },
    ...
    },
    {
      ...
      createdAt: now,
      ozellikler: [
        { id: '1', baslik: '5.000 SMS Kredisi', aciklama: 'Toplam 5.000 adet SMS gönderim hakkı', dahil: true },
    ...
    },
    {
      ...
      createdAt: now,
      ozellikler: [
        { id: '1', baslik: '10.000 SMS Kredisi', aciklama: 'Toplam 10.000 adet SMS gönderim hakkı', dahil: true },
