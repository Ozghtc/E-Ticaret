  ...
  return <div className="min-h-screen bg-gradient-to-br from-rose-50 to-pink-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <button onClick={() => navigate('/admin/urun-ekleme-yeni')} className="flex items-center text-white hover:text-rose-200 mr-6">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-4 text-center">{t("common.takı_aksesuar_ürünü_ekle")}</h1>
          <p className="text-gray-600 text-lg mb-8 text-center">{t("common.bu_form_henüz_hazırlanıyor")}</p>
          
          {/* Placeholder Content */}
          <div className="bg-rose-50 border border-rose-200 rounded-lg p-6">
            <h3 className="font-semibold text-rose-800 mb-4">{t("common.takı_özel_alanları")}</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-rose-700">
              ...
              <div>
                <h4 className="font-medium mb-2">{t("common.takı_özel")}</h4>
                <ul className="space-y-1">
                  <li>{t("common.malzeme_bilgisi_altın_gümüş_çelik")}</li>
                  <li>• Karat/ayar bilgisi</li>
                  <li>{t("common.taş_türü_ve_özellikleri")}</li>
                  <li>• Sertifika bilgileri</li>
                  <li>{t("common.boyut_ölçü_seçenekleri")}</li>
