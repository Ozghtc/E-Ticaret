...
function OtomotivUrunForm() {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-gray-50 to-slate-50">
      {/* Header */}
      <header className="bg-gray-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <button onClick={() => navigate('/admin/urun-ekleme-yeni')} className="flex items-center text-white hover:text-gray-200 mr-6">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-4 text-center">{t("common.otomotiv_ürünü_ekle")}</h1>
          <p className="text-gray-600 text-lg mb-8 text-center">{t("common.bu_form_henüz_hazırlanıyor")}</p>
          
          {/* Placeholder Content */}
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
            <h3 className="font-semibold text-gray-800 mb-4">{t("common.otomotiv_özel_alanları")}</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700">
              ...
              <div>
                <h4 className="font-medium mb-2">{t("common.otomotiv_özel")}</h4>
                <ul className="space-y-1">
                  <li>{t("common.araç_uyumluluğu_marka_model")}</li>
                  <li>{t("common.model_yılı_aralığı")}</li>
                  <li>{t("common.parça_numarası_oem_kodu")}</li>
