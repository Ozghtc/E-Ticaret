...
export default function EcoTextileTemplate({ products, category }: EcoTextileTemplateProps) {
    ...
    <div className="min-h-screen bg-green-50">
      ...
      <header className="bg-white shadow-sm border-b border-green-200">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="text-center">
            ...
            <p className="text-green-600 text-lg">Sürdürülebilir Moda</p>
          </div>
        </div>
      </header>
      ...
      <section className="py-20 bg-gradient-to-r from-green-100 to-emerald-100">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <h2 className="text-5xl font-medium text-green-900 mb-6">
            Doğa Dostu Moda
          </h2>
          <p className="text-xl text-green-700 mb-8 leading-relaxed">
            Organik kumaşlar, çevre dostu üretim
          </p>
