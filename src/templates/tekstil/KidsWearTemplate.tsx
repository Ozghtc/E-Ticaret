...
export default function KidsWearTemplate({ products, category }: KidsWearTemplateProps) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-100 to-pink-100">
      ...
      <header className="bg-white/90 backdrop-blur-sm shadow-lg border-b-4 border-yellow-300">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="text-center">
            ...
            <p className="text-orange-500 text-xl font-bold">Renkli Dünya!</p>
          </div>
        </div>
      </header>
      ...
      <section className="py-20">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <h2 className="text-6xl font-bold text-green-600 mb-6 animate-bounce">
            Çocuklar İçin!
          </h2>
          <p className="text-2xl text-blue-600 mb-8 leading-relaxed font-bold">
            Renkli, eğlenceli, konforlu kıyafetler
          </p>
