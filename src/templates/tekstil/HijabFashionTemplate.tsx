...
export default function HijabFashionTemplate({ products, category }: HijabFashionTemplateProps) {
    ...
    <div className="min-h-screen bg-purple-50">
      ...
      <header className="bg-white shadow-sm border-b border-purple-200">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <div className="text-center">
            ...
            <p className="text-purple-600 text-lg">Zarif Tesettür Koleksiyonu</p>
          </div>
        </div>
      </header>
      ...
      <section className="py-20 bg-gradient-to-r from-purple-100 to-pink-100">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <h2 className="text-5xl font-medium text-purple-900 mb-6">
            Zarif Tesettür
          </h2>
          <p className="text-xl text-purple-700 mb-8 leading-relaxed">
            Modern çizgiler, geleneksel değerler
          </p>
          <button className="bg-purple-600 text-white px-8 py-4 font-medium text-lg hover:bg-purple-700 transition-colors rounded-lg">
            Koleksiyonu İncele
          </button>
        </div>
      </section>
